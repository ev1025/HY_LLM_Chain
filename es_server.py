...
async def lifespan(app: FastAPI):
    ...
    # RAG 기본 체인 (vdb_name을 'elasticsearch'로 변경)
...
# FastAPI app & CORS
# =========================
app = FastAPI(title="KGS Elasticsearch RAG 서버", lifespan=lifespan) # title 변경
origins = [
...
if __name__ == "__main__":
    uvicorn.run("es_server:app", host="0.0.0.0", port=8000, reload=True)